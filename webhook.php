...
if ($text === '/start') {
    ...
    $caption = "
    👋 **Welcome to the Dolphin World!** 🐾🎮

    Get ready for a tail-wagging journey where every paw-tap leads to bigger rewards! Here’s what’s waiting for you:

    ✨ **Play Dolphin**: Tap the Dolphin bone and watch your balance fetch amazing rewards!
    🐕 **Mine for PUPS**: Collect Dolphin Tokens with every action your furry friend takes.
    📋 **Complete Dolphin Tasks**: Help your pup finish fun missions and earn even more treats!
    ...
    Got friends, family, or fellow dolphin lovers? Invite them to join the fun and grow your earnings as the pack gets bigger! The more paws, the better!

    🔗 **Connect with Us:**
    - Developed by [@itking007](https://t.me/itking007)
    - Join our [Dolphin Lovers Telegram Pack](https://t.me/companybrodigital) for the latest updates and tail-wagging fun!

    🐾 **Get Started Now** and take your dolphin on the ultimate Dolphin world!
